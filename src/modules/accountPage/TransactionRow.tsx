...
export type TransactionRow = {
    ...
    setTransToDel: React.Dispatch<React.SetStateAction<DeleteTransaction | undefined>>;
    modalRef: React.RefObject<HTMLDialogElement>;
}

const TransactionRow: React.FC<TransactionRow> = ({trans, setTransToDel, modalRef}) => {
